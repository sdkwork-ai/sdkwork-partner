...
Module `sdkwork-partner` · runtime code `partner` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `partner-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `partner-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `partner-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `partner-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `partner.sdkwork.com` | 443 ssl + 80 |
