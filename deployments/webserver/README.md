...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `partner-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `partner-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `partner-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `partner.sdkwork.com` | 443 ssl + 80 |
