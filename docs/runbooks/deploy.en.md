# Runbook — sdkwork-partner deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-partner-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-partner/bundle`, loads the image, starts
